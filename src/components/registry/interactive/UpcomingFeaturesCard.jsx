    ...
    <section className="group relative w-full max-w-3xl overflow-hidden rounded-[30px] border border-white/10 bg-[#0d0d10] p-1 shadow-[0_18px_60px_rgba(0,0,0,.24)]">
      ...
      <div className="relative rounded-[26px] border border-white/[0.07] bg-black/10 p-5 sm:p-6">
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          ...
          <button
            type="button"
            className="group/button inline-flex shrink-0 items-center gap-2 self-start rounded-xl border border-white/10 bg-white/[0.035] px-3.5 py-2.5 text-[11px] font-semibold text-slate-300 transition hover:-translate-y-0.5 hover:bg-white/[0.06] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-300"
          >
            View roadmap
            <ArrowUpRight
