  ...
  return (
    <div className="flex h-full flex-col">
      <div className={"flex h-[70px] items-center border-b border-white/[0.07] px-3 " + (collapsed ? "justify-center" : "justify-between")}>
        ...
        {mobile && (
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/[0.08] text-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
          >
            <X className="h-4 w-4" />
          </button>
        )}
      ...
      <div className="flex-1 p-2.5">
        {!collapsed && (
          <div className="mb-3 flex h-10 items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.025] px-3 text-slate-600 focus-within:border-blue-300/20">
        ...
        <nav className="space-y-1">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <Icon className={"h-4 w-4 shrink-0 " + (selected ? "text-blue-300" : "text-slate-700 group-hover:text-slate-400")} aria-hidden="true" />
        ...
        {[
          ...
          <button
            ...
            className={"flex h-10 w-full items-center rounded-xl text-slate-700 transition hover:bg-white/[0.035] hover:text-slate-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300 " + (collapsed ? "justify-center" : "gap-3 px-3")}
          >
      ...
      <div className="border-t border-white/[0.07] p-2.5">
        {!mobile && (
          <button
            ...
            className={"mb-2 flex h-9 w-full items-center rounded-xl border border-white/[0.07] bg-white/[0.02] text-slate-600 transition hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300 " + (collapsed ? "justify-center" : "justify-between px-3")}
          >
        ...
        <div className={"flex items-center rounded-xl border border-white/[0.07] bg-white/[0.02] p-2 " + (collapsed ? "justify-center" : "gap-3")}>
          <div aria-hidden="true" className="flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px] bg-gradient-to-br from-indigo-300/30 to-blue-300/20 text-[10px] font-bold text-slate-200">MK</div>
      ...
      <div className="flex min-h-[540px]">
        ...
        {mobileOpen && <>
          ...
          <aside
            ...
            className="absolute inset-y-0 left-0 z-30 w-[235px] border-r border-white/10 bg-[#040a12] shadow-2xl md:hidden"
          >
          ...
          <header className="flex h-[70px] items-center justify-between border-b border-white/[0.07] px-4 sm:px-5">
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/[0.08] text-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300 md:hidden"
              >
            ...
            <button
              type="button"
              className="rounded-xl border border-white/[0.08] bg-white/[0.025] px-3 py-2 text-[10px] font-medium text-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-300"
            >
              Sep 01 – Sep 30
            </button>
          </header>
          ...
          <div className="p-4 sm:p-5">
            ...
            <div className="mt-3 grid gap-3 lg:grid-cols-[1.45fr_.55fr]">
              ...
              <article className="rounded-[20px] border border-white/[0.08] bg-gradient-to-b from-blue-300/[0.05] to-transparent p-4">
                ...
                >
                  <div className="flex h-24 w-24 items-center justify-center rounded-full bg-[#111114]"><div aria-hidden="true" className="text-center"><p className="text-2xl font-semibold text-white">74%</p><p className="text-[9px] text-slate-700">complete</p></div></div>
                </div>
              </article>
            </div>
          </div>
