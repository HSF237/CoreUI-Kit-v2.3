export default function SkeletonDashboard() {
  return (
    <section className="w-full max-w-4xl rounded-[28px] border border-[var(--border,rgba(255,255,255,.1))] bg-[var(--surface,#0d0d10)] p-5 shadow-[0_18px_60px_rgba(0,0,0,.24)] sm:p-6">
      <div role="status" aria-label="Loading dashboard" className="animate-pulse motion-reduce:animate-none">
        <div aria-hidden="true">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-3">
            {[0, 1, 2].map((item) => (
              <div key={item} className="rounded-2xl border border-[var(--border,rgba(255,255,255,.1))] bg-white/[0.02] p-4">
          ...
          <div className="mt-3 rounded-2xl border border-[var(--border,rgba(255,255,255,.1))] bg-white/[0.02] p-4">
